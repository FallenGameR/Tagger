 ...
 * Copyright © 1997-2007 John Robbins -- All rights reserved.
 -----------------------------------------------------------------------------*/
using System;
    ...
    internal abstract class ArgParser
    {
        ...
        public Boolean Parse ( String [] args )
        {
                 ...
                 currArg++ )
            {
                ...
                {
                    if ( 0 == String.CompareOrdinal ( args [ currArg ] ,
                                                      0 ,
                                                      switchChars [ n ] ,
                                                      0 ,
                                                      1 ) )
                ...
                if ( true == isSwitch )
                {
                    ...
                    if ( -1 != n )
                    {
                        ...
                        {
                            // This is a legal switch, notified the derived class 
                            // of this switch and its value.
